function [newPhediLoc, side, strechFactorVert, strechFactorHorz,HorzDisplacement,VertDisplacement, polynomFit] =...
        Movie_phedi_findShiftOfSlope_fitFresnel_onlyShift(signal, PhediCoordinates,...
        strechFactorVertIN, strechFactorHorzIN,VertDisplacementIN)
...
%             strechFactorVertIN(phedi_idx), strechFactorHorzIN(phedi_idx), [],VertDisplacementIN(phedi_idx));
