function [frameCount, PhediLocation, slopeIncline, StrechingFactorsMat] = Movie_phedi_calculate_continues_shift(...
    ...
    %% set defaults
    [numOOM, relative2first, QAD,interpMethod, P] = setDefaults4function(varargin,3,1,0,'v5cubic',0.375);
...
%                             StructSig1,StructSig2, PhediCoordinatesUpdate, [],numOOM);
            slopePenalty = -2;
            [PhediShift, slopeIncline_i] = Movie_phedi_findShiftBetweenSlopes(...
                RowOverTime(frameCount(rowIdx-1),:),RowOverTime(frameCount(rowIdx),:), PhediCoordinatesUpdate, 2, slopePenalty);
