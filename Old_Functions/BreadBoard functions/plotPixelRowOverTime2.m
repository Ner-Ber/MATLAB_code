...
RowOverTime_file=[main_folder '\sample_' num2str(video_num) '\RowOverTime' num2str(video_num) '.mat'];

%% load images

switch exist(RowOverTime_file, 'file')
    case 0
        ...
        save(RowOverTime_file,'RowOverTime');
    case 2
        load(RowOverTime_file);
...
%% plot momement of one asperitiy

% [x y]=getline;
% improfile(RowOverTime,x,y)
