...
Data2Aquire = {'Date', 'Time', 'Record Rate(fps)', 'Shutter Speed(s)',...
    ...
    'Start Frame'};
fieldNames = {'Date', 'Time', 'RecordRate_fps', 'ShutterSpeed_s',...
    'EffectiveBitDepth','ImageWidth','ImageHeight', 'TotalFrame',...
    'StartFrame'};

%---open file to read
fid1=fopen(sprintf('%s.cih',filename),'r');
if fid1<1; display([filename ' filenames could not be found']); ImageData=0; return; end
