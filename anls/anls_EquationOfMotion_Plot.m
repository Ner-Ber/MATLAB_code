function anls_EquationOfMotion_Plot(anl)
...
%Uxy0_Offset=0;
anl.y3_5.Uxy0_f=anl.y3_5.Uxy0_f+Uxy0_Offset;

index_sg=(4:length(anl.y3_5.x_sg)); %choose strain gages that will affect Uxy
...
%G(anl.y3_5.x_sg(index_sg)>130)=Gamma/1.5;
%---For 150mm
%G=G+Gamma;
...
for j=1:length(anl.e)
    %for j=7:7
    x=[0;30; anl.y3_5.x_sg(index_sg)']*1e-3;
    %x=[0; anl.y3_5.x_sg(index_sg)']*1e-3;
    %-------Define pre stress
