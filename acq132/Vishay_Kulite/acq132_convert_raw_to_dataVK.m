function acq132=acq132_convert_raw_to_dataVK(exp_dir,ch_Master,ch_Slave)
...
exp_details=expDetailsReadVK(exp_dir);
...
if find(sg_names~=1)
    ...
    [Sxx,Syy,Sxy,Uxx,Uyy,Uxy,note]=calculate_stress_strain(U1,U2,U3,sg_angle);
end    
if find(sg_names==1)
...
elseif exist('sK','var') % Kulite only
    ...
    acq132=struct('V',V,'x_sg',x_sg,'Uxx',Uxx,'Uyy',Uyy,'Uxy',Uxy,'Sxx',Sxx,'Syy',Syy,'Sxy',Sxy,'note',note);
end
% acq132.note=note;
acq132.x_sg=x_sg;
