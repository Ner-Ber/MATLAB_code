function acq132_stream_plot_cont(plot_conf,use_offset)
...
if strcmp(plot_conf,'exp') || strcmp(plot_conf,'ds')
    ...
    for k=1:3000
        ...
        [~,Syy,Sxy,~,Uyy,Uxy]=calculate_stress_strain(sg,exp_details);
        ...
        if strcmp(plot_conf,'exp')
            ...
            title('Uyy ');
            subplot(3,2,4);
            plot(x_sg([1:5 7:15]),Uxy([1:5 7:15]),'.-');
            set(gca,'FontSize',16,'FontWeight','bold')
            title('Uxy ');
            ...
            subplot(3,2,5);
            plot(x_sg([1:5 7:15]),Sxy([1:5 7:15])./Syy([1:5 7:15]),'.-');
            xlim([0 150]);
            ylim([0.4 1]);
            set(gca,'FontSize',16,'FontWeight','bold')
            title('Sxy/Syy ');
