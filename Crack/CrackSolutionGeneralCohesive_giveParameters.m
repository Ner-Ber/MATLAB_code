function sol=CrackSolutionGeneralCohesive_giveParameters(v,h,varargin)
%CrackSolutionGeneralCohesive_giveParameters will calculate the cohesive
%zone model assuming Gamma and tau_p.
%
% INPUTS:
% 1) v - Cf in [Cr] units
% 2) h - height in meters [m]
% VARAGRIN (by this order):
% Gamma,tau_p, Cd, Cs, Cr, nu,mu, PlaneStrain
%
%
% all formulas taken from Samudrala@Samudrala,Huang&Rosakis JGR2002

%% setDefaults
[Cd_def, Cs_def, Cr_def, nu_def , ~, ~, mu_def, Gamma_def, PlaneStrain_def, tau_p_def]=CrackSolutionMaterialProperties;

[Gamma,tau_p, Cd, Cs, Cr, nu,mu, PlaneStrain] = setDefaults4function(varargin,...
    Gamma_def,tau_p_def, Cd_def, Cs_def, Cr_def, nu_def ,mu_def,PlaneStrain_def);
