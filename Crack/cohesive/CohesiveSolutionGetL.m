function L = CohesiveSolutionGetL(v,Gamma,tau_p,varargin)
    % L = CohesiveSolutionGetL(v,Gamma,tau_p,cohesiveFun,PlaneFlag,x_range,dx)
    %
    ...
    %tau_p - cohesive peak shear stress
    %
    % OPTIONAL:
