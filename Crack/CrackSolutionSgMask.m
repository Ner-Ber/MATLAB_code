function mask=CrackSolutionSgMask(dx)
...
sg.alpha=pi/4;
sg.l=0.38E-3;%[m] 
sg.width=0.34E-3;%approxiamtly square
sg.Up_y=0.45E-3; %y location of the upper sensor's center to the center of the rossete 
sg.Plus_y=-0.4E-3;
sg.Plus_x=0.4E-3;
sg.Minus_y=-0.4E-3;
sg.Minus_x=-0.4E-3;
sg.BoxSize=1.55E-3;% The global box (mask)size.  
...
% Box of zeros boundry is needed for easier rotation 
...
maskBoxSize=2*ceil(sg.BoxSize/dx/2)+1;%Odd size is easier
