function [Images,Cam_Meta] = IDT_ReadImages(exp_dir,eventNum,pre_event,interval,post_event,smt,lineNum)
...
startl=IDT_Meta.EventFrame-pre_event;
endl=IDT_Meta.EventFrame+post_event;
