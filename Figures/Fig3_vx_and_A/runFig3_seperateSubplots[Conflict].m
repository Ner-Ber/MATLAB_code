...
varVpeak_All_filter = varVpeak_All(Logical_tot);
...
errorbar(Cf_filter(groupCatagrs_filter==2),Vpeak_All_filter(groupCatagrs_filter==2), sqrt(varVpeak_All_filter(groupCatagrs_filter==2)),'ks','LineWidth',1,'MarkerSize',4);
errorbar(Cf_filter(groupCatagrs_filter==1),Vpeak_All_filter(groupCatagrs_filter==1), sqrt(varVpeak_All_filter(groupCatagrs_filter==1)),'ko','LineWidth',1,'MarkerSize',4);
errorbar(Cf_filter(groupCatagrs_filter==3),Vpeak_All_filter(groupCatagrs_filter==3), sqrt(varVpeak_All_filter(groupCatagrs_filter==3)),'ko','MarkerFaceColor','r','LineWidth',1,'MarkerSize',4);
xlim([0 1300]);
ylim([0 1.4]);
xlabel('C_f/C_R');
ylabel('v_x peak [m/s]');
...
%% slip vel and A/A0
Vx_and_A_F = figure;
Movie_phedi_plotWithSg(PhediStructCell{EvNum},'00',{'avgPhediVel'},[],[],[],Vx_and_A_F);
Vx_and_A = Vx_and_A_F.Children;
