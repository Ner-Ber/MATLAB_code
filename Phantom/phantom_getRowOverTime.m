function RowOverTime = phantom_getRowOverTime(expPath, eventNum, Cam_Meta,varargin)
% RowOverTime = phantom_getRowOverTime(expPath, eventNum, Cam_Meta,varargin)
% Optional:
...
Images = phantomReadIms(expPath,eventNum,fromFrame,1,toFrame,1,lineNum);
