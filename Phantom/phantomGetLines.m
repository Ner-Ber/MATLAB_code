function Ims=phantomGetLines(exp_dir,eventNum,Tstart,Tinterval,Tend,timeBase,smt,includeFlag,lineNum)
...
[Ims.lines Ims.Included]=phantomReadLines(exp_dir,eventNum,startl,interval,endl,smt,includeFlag,lineNum);
