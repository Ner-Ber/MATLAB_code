function Ims = phantomReadIms_BigPic(exp_dir,eventNum,startl,interval,endl,smt,lineNum)
% Ims = phantomReadIms(exp_dir,eventNum,startl,interval,endl,smt,lineNum)
